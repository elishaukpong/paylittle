    ...
    <div class="row justify-content-center">
        <div class="col-md-8 col-12">
            ...
            <form method="POST" action="{{ route('save.regphase') }}" class="mt-5">
                ...
                <div class="form-group row">
                    <div class="col-md-6 col-12 mx-auto ">
                        <input id="city" type="text" class="form-control{{ $errors->has('city') ? ' is-invalid' : '' }} auth-inputs" name="city" value="{{ old('city') }}" placeholder="City"
                               required>
                        @if ($errors->has('city'))
                            <span class="invalid-feedback" role="alert">
                ...
                <div class="form-group row">
                    <div class="col-md-6 col-12 mx-auto ">
                        <input id="address" type="text" class="form-control{{ $errors->has('address') ? ' is-invalid' : '' }} auth-input" name="address" value="{{ old('address') }}" placeholder="Address"
                            required>
