...
@section('content')
  <div class="jumbotron text-center create-project-jumbotron ">
        <div class="jumbotron-cover py-4">
            <h1 class="font-weight-bold text-white ">Create Projects</h1>
        </div>
    </div>
    <div class="container">

    <div class="row">
        <div class="col-md-5 col-12 p-0 create-project-left">
            <div class="create-project-left-cover">
             ...
             <form action="{{route('project.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        {{-- <div class="form-group btn-file text-right pr-5 ">
                            ...
                            <div class="form-group">
                                <input type="file" name="avatarobject" id="book_avatar">
                            </div>
                        <div class="row">
