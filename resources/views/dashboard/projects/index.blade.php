...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <h1 class="p-c font-weight-light"> All Projects
                    <small class="badge badge-pill badge-primary h6">{{$count}}</small>
                </h1>
                <hr>
            </div>
        </div>
                ...
                <div class="col-md-4 col-12 mt-3">
                    <div class="card">
                        ...
                        <div class="card-body mt-3">
                            ...
                            <br>
                            <p class="float-left text-secondary">{{$project->formattedamountsponsored}}
                                <small>Raised</small>
                            </p>
                            <p class="float-right text-secondary">
                                <small>Total</small> {{$project->formattedamount}}</p>
                            <br><br>
