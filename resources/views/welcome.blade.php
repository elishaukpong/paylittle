...
@section('content')
    ...
    <section class="home-jum">
        <div class="container my-5 py-5">
            <div class="row">
                <div class="col-12">
                    <h3 class="text-center text-light">With Pay Little, you could either get help with optimizing your income to afford a range of commodities, or you could be a benefactor and help others live a comfortable life,<br> this comes with its perks  </h3>
                </div>
            </div>
        </div>
    </section>
